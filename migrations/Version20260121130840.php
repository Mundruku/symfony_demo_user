 ...
 */
final class Version20260121130840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patient (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(122) NOT NULL, age INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
